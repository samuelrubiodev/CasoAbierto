        ...
        if (Input.GetKeyDown(KeyCode.E))
        {
            ...
            if (Physics.Raycast(playerCamera.transform.position, playerCamera.transform.forward, out hit, interactDistance))
            {
                ...
                if (hit.collider.CompareTag("Chair"))
                {
                    ...
                    gameObject.transform.position = new Vector3(0.15f, 2.01f, -7.903907f);

                    this.playerCanMove = false;

                    GameObject chair = hit.collider.gameObject;
    ...
    private void OnGUI()
    {
        ...
        if (Physics.Raycast(playerCamera.transform.position, playerCamera.transform.forward, out hit, interactDistance))
        {
            if (hit.collider.CompareTag("Door"))
            {
                ...
                customStyle.normal.textColor = Color.white; // Color del texto blanco
                customStyle.fontSize = 30; // Tamaño de la fuente
                customStyle.alignment = TextAnchor.MiddleCenter; // Centrar el texto

                // Crear un contenido con borde
                ...
                Rect borderRect = new Rect(
                    screenCenterX - labelWidth / 2 - 2, // -2 para el borde
                    screenCenterY - labelHeight / 2 - 2, // -2 para el borde
                    labelWidth + 4, // +4 para el borde
                    labelHeight + 4 // +4 para el borde
                );
                ...
                // Crear el rectángulo para el texto
                ...
                // Dibujar el texto
                GUI.color = Color.white; // Restaurar el color para el texto
