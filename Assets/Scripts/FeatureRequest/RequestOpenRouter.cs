...
namespace FeatureRequest {
    public class RequestOpenRouter : IFeatureRequest<string> {
        ...
        private static RequestOpenRouter instance;
        public static RequestOpenRouter GetInstance()
        {
            instance ??= new RequestOpenRouter();
            return instance;
        }

        private string openRouterApiKey;
        public static string DATOS_CASO = "";
        public JObject openrouterResponse;

        private RequestOpenRouter() {
        ...
        public async Task<string> SendRequest(string prompt)
        {
            ...
            {  
                ...
                openrouterResponse = jsonResponse;
